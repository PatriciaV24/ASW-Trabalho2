 ...
 * pairs of pegs and holes should be slightly different. This variation can be
 * be introduced with a random number generator. To represent pegs and holes the
 * shape should use Bezier lines CurveTo.
 *
...
public class StandardCutting implements Cutting {
	...
	public Map<Integer, PieceShape> getShapes(PuzzleStructure structure) {
		...
		PieceShape c1 = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
		...
		PieceShape c1Bot = new PieceShape(begin).addSegment(new CurveTo(botMiddleRig, botMiddleRig, botMiddle))
		...
		PieceShape c1BotLeft = new PieceShape(begin).addSegment(new CurveTo(botMiddleRig, botMiddleRig, botMiddle))
				.addSegment(new CurveTo(botMiddleLeft, botMiddleLeft, botLeft))
		...
		PieceShape c1BotRig = new PieceShape(begin).addSegment(new CurveTo(botMiddleRig, botMiddleRig, botMiddle))
				.addSegment(new CurveTo(botMiddleLeft, botMiddleLeft, botLeft))
				.addSegment(new CurveTo(topLeft, leftBotOut, leftOut))
				.addSegment(new CurveTo(leftTopOut, botLeft, topLeft))
				.addSegment(new CurveTo(topRigh, topLeftOut, topOut))
		...
		PieceShape c1Left = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
				.addSegment(new CurveTo(leftMiddleBot, botRigh, botLeft))
				.addSegment(new CurveTo(leftMiddleBot, leftMiddleBot, leftMiddle))
				.addSegment(new CurveTo(leftMiddleTop, leftMiddleTop, topLeft))
				.addSegment(new CurveTo(topRigh, topLeftOut, topOut))
		...
		PieceShape c1Top = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
				.addSegment(new CurveTo(leftMiddleBot, botRigh, botLeft))
				.addSegment(new CurveTo(topLeft, leftBotOut, leftOut))
				.addSegment(new CurveTo(leftTopOut, botLeft, topLeft))
		...
		PieceShape c1TopLeft = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
				.addSegment(new CurveTo(leftMiddleBot, botRigh, botLeft))
				.addSegment(new CurveTo(leftMiddleBot, leftMiddleBot, leftMiddle))
				.addSegment(new CurveTo(leftMiddleTop, leftMiddleTop, topLeft))
				.addSegment(new CurveTo(topMiddleLeft, topMiddleLeft, topMiddle))
		...
		PieceShape c1TopRig = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
				.addSegment(new CurveTo(leftMiddleBot, botRigh, botLeft))
				.addSegment(new CurveTo(topLeft, leftBotOut, leftOut))
				.addSegment(new CurveTo(leftTopOut, botLeft, topLeft))
				.addSegment(new CurveTo(topMiddleLeft, topMiddleLeft, topMiddle))
		...
		PieceShape c1Rig = new PieceShape(begin).addSegment(new CurveTo(botLeft, rigMiddleBot, botIn))
				.addSegment(new CurveTo(leftMiddleBot, botRigh, botLeft))
				.addSegment(new CurveTo(topLeft, leftBotOut, leftOut))
				.addSegment(new CurveTo(leftTopOut, botLeft, topLeft))
				.addSegment(new CurveTo(topRigh, topLeftOut, topOut))
